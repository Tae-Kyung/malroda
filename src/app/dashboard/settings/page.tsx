        ...
        <div className="max-w-3xl mx-auto py-8 px-4 sm:px-0">
            <div className="bg-white shadow rounded-2xl border border-gray-100 overflow-hidden">
                <div className="px-6 py-5 border-b border-gray-100 bg-gray-50 flex items-center justify-between">
                    <div>
                        <h3 className="text-lg leading-6 font-medium text-gray-900">농장 기본 설정</h3>
                        <p className="mt-1 max-w-2xl text-sm text-gray-500">말로다 AI가 인식할 농장의 이름과 구역을 관리합니다.</p>
                    </div>
                    {members?.role === 'owner' && (
                ...
                <div className="px-6 py-6 sm:p-10">
                    {farmData ? (
                        ...
                        <div className="text-center py-6">
                            <p className="text-gray-500 text-sm">소속된 농장 정보가 없습니다.</p>
                        </div>
                    )}
                </div>
            </div>
